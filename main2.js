(() => {
  ...
  function preload() {
    ...
    this.load.image("player", `${ASSET_BASE}/player2.png`);
  }
  ...
  function syncMobileUI() {
    ...
    if (chatToggleBtn) {
      chatToggleBtn.style.fontSize = isMobile ? "13px" : "16px";
      chatToggleBtn.style.padding = isMobile ? "9px 16px" : "12px 22px";
      chatToggleBtn.style.bottom = isMobile ? "12px" : "14px";
      chatToggleBtn.style.borderRadius = isMobile ? "14px" : "18px";
    }

    if (chatPanel) {
      chatPanel.style.bottom = isMobile ? "12px" : "14px";
      chatPanel.style.gap = isMobile ? "8px" : "10px";
      chatPanel.style.maxWidth = isMobile ? "calc(100% - 18px)" : "520px";
    }
    ...
    if (chatSendBtn) {
      chatSendBtn.style.fontSize = isMobile ? "13px" : "15px";
      chatSendBtn.style.padding = isMobile ? "10px 12px" : "12px 16px";
    }
    ...
    if (exitBtn) {
      exitBtn.style.bottom = isMobile ? "12px" : "14px";
      exitBtn.style.right = isMobile ? "12px" : "16px";
      exitBtn.style.fontSize = isMobile ? "13px" : "16px";
      exitBtn.style.padding = isMobile ? "10px 14px" : "12px 20px";
    }

    if (enterModal) {
      enterModal.style.width = isMobile ? "calc(100% - 24px)" : "auto";
      enterModal.style.minWidth = isMobile ? "0" : "260px";
      enterModal.style.maxWidth = isMobile ? "340px" : "none";
  ...
  function applyResponsiveShell() {
    ...
    Object.assign(shellEl.style, {
      position: "relative",
      width: isMobile ? "100vw" : "min(1400px, 100vw)",
